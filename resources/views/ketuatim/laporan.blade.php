...
<body>
    ...
    <div class="max-w-7xl mx-auto px-4 space-y-6" x-data="{ open: false }">
        <div class="p-6">
            ...
            <!-- Card -->
            <div x-data="{ editMode: false }" class="bg-white rounded-xl shadow p-6 border">
                ...
                <!-- Form Edit (hanya tampil kalau editMode = true) -->
                <form x-show="editMode" >
                    <!-- button -->
                    <div class="flex space-x-2 mb-4">
                        <button type="button" disabled
                                class="bg-blue-800 text-white text-xs px-4 py-2 rounded">
                            Edit Rencana
                        </button>
                        <button type="button" disabled
                                class="bg-gray-200 text-gray-500 text-xs px-4 py-2 rounded cursor-not-allowed">
                            Edit Realisasi
                        </button>
                    </div>  
