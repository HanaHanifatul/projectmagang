            ...
            <div class="flex h-16 items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <div class="hidden md:block ">
                        ...
                        <a href="/" aria-current="page" class="rounded-md px-3 py-2 text-sm font-medium flex items-center gap-1 {{request()-> is('/') ? 'bg-blue-100 text-blue-900' : ' hover:bg-white/5 hover:text-white'}}">
